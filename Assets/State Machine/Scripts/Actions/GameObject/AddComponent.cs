...
namespace StateMachine.Action{
	...
	public class AddComponent : GameObjectAction {
		...
		public override void OnEnter ()
		{
			...
			if (component == null) {
				store.Value = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent (((GameObject)gameObject.Value), "Assets/State Machine/Scripts/Actions/GameObject/AddComponent.cs (29,19)", className.Value);
			} else {
